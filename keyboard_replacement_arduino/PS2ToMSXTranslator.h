...
#define TO_COLUMN_ROW(x, y) (((x << 8) & 0xFF00) | (y & 0xFF))
#define COLUMN_FROM_EVENT(event) ((event & 0xFF00) >> 8)
#define ROW_FROM_EVENT(event) (event & 0xFF)

namespace ps2
{
    /**
     *  Describes a neutral encoding for keypresses used with the \ref PS2ToMSXTranslator.
     */
    enum KeyCode : uint16_t {
        ...
        PS2_ALT      = 0x800,
        PS2_GUI      = 0x200,
        PS2_PRESS    = 0x100, //key pressed or released
    ...
    public:
        ...
        KeyCode translatePs2Keycode(KeyboardOutput code) {
            ...
            if (this->isUnmake) {
                ...
                this->modifiers |= KeyCode::PS2_PRESS;              
            }
